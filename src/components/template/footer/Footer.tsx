      ...
      <div className="container footer-container">
        <div className="footer-item__aboutus">
          ...
          <p>
            ...
            چاپگرها و متون بلکه روزنامه و ده از طراحان گرافیک است چاپگرها و متون
            بلکه روزنامه و ده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و
            ده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و ده از طست
            زنامه و مجله در ستون و سطرآنچنان که لازم است{" "}
          </p>
        </div>
